...
<body>
 ...
 <?php include_once('includes/header.php');?>
  ...
  <section class="hero-banner text-center">
    <div class="container">
      <img src="img/io1.png" alt="descriptive text" style="width:180px;height:200px;float:left;position: absolute;
      top: 230px;left: 150px;">
      <h1 style=" padding-left: 60px;">Curfew e-Pass Management System</h1>
    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-5 col-lg-2 text-center text-md-left mb-3 mb-md-0">
          <h3 style="color: #401B23">Search Your Pass Here!</h3>
        </div>
        <div class="col-md-7 col-lg-10 pl-2 pl-xl-5">
          <form class="form-inline flex-nowrap form-domainSearch" method="post">
            ...
            <button type="submit" class="button rounded-1" name="search" id="submit" style="background-color: #401B23">Search</button>
          </form>
           <?php

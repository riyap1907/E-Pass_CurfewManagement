        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu" >
                    <li style="border-bottom:0.5px solid #f3f3f3 !important">
                        <!-- user image section-->
                        <div class="user-section" style="background-color:#282f39">
...
{               ?>
                                <div><strong style="color: white"> <?php  echo $row->AdminName;?></strong></div>
                    ...
                    <li class="selected" style="background-color: #282f39 ;border-bottom:0.5px solid #f3f3f3 !important">
                        <a href="dashboard.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
                    <li style="background-color: #282f39;border-bottom:0.5px solid #f3f3f3 !important">
